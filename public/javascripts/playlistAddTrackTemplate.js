...
templates['playlist_add.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "      <div>\n        <input type=\"checkbox\" id=\""
    ...
    + "\" name=\"titles\" value=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"title") || (depth0 != null ? lookupProperty(depth0,"title") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data,"loc":{"start":{"line":7,"column":67},"end":{"line":7,"column":76}}}) : helper)))
    + ","
    + alias4(((helper = (helper = lookupProperty(helpers,"artist_id") || (depth0 != null ? lookupProperty(depth0,"artist_id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"artist_id","hash":{},"data":data,"loc":{"start":{"line":7,"column":77},"end":{"line":7,"column":90}}}) : helper)))
    + "\" />\n        <label for=\""
    ...
    + " by "
    + alias4(((helper = (helper = lookupProperty(helpers,"artist_name") || (depth0 != null ? lookupProperty(depth0,"artist_name") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"artist_name","hash":{},"data":data,"loc":{"start":{"line":8,"column":44},"end":{"line":8,"column":59}}}) : helper)))
    + "</label>\n      </div>\n";
  ...
  return "<form action=\"/playlist/"
    ...
    + "/add\" method=\"post\">\n  <h3 class='font-bold text-2xl' >Add tracks to playlist</h3>\n  <fieldset class=\"mb-5\">\n    <p class=\"text-lg font-medium text-gray-700\">Tracks</p>\n"
    ...
    + "  </fieldset>\n  <div>\n    <button type=\"submit\" value=\"Update\" class=\"text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800\" >Add</button>\n  </div>\n</form>";
},"useData":true});
})();