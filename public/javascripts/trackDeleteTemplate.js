...
templates['track_del.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "      <div>\r\n        <input type=\"radio\" id=\""
    ...
    + "\" name=\"title\" value=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"title") || (depth0 != null ? lookupProperty(depth0,"title") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data,"loc":{"start":{"line":7,"column":63},"end":{"line":7,"column":72}}}) : helper)))
    + "\" />\r\n        <label for=\""
  ...
  return "<form action=\"/track/delete\" method=\"post\">\r\n  <h3>Delete track</h3>\r\n  <fieldset>\r\n    <legend>Tracks:</legend>\r\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"tracks") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":5,"column":4},"end":{"line":10,"column":13}}})) != null ? stack1 : "")
